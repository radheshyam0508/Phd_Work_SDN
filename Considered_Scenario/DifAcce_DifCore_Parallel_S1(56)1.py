...
'UPDATED Example for Handover for Difference Access and Different Core_Parallel S1(5/6)1'
...
def topology(args):
    ...
    if '-s' in args:
        Tra1_args['position'], Tra3_args['position'],  Car1_args['position'] = '30,30,0', '350,10,0' '50,230,0'

    Tra1 = net.addStation('Tra1', mac='00:00:00:00:00:01', ip='192.168.7.101/24', position='30,30,0', **Tra1_args)
    Tra2 = net.addStation('Tra2', mac='00:00:00:00:00:03', ip='192.168.7.102/24', position='30,10,0')
    Tra3 = net.addStation('Tra3', mac='00:00:00:00:00:05', ip='192.168.7.103/24', position='350,10,0', **Tra3_args)

    Car1 = net.addStation('Car1', mac='00:00:00:00:00:02', ip='192.168.0.201/24', position='50,230,0',**Car1_args)
    Car2 = net.addStation('Car2', mac='00:00:00:00:00:04', ip='192.168.0.202/24', position='50,210,0')
    Car3 = net.addStation('Car3', mac='00:00:00:00:00:06', ip='192.168.0.203/24', position='350,210,0')
    ...
    ap2 = net.addAccessPoint('ap2', ssid='ssid-ap2', mode='a', channel='40', position='290,220,0', **kwargs)
    
    ap3 = net.addAccessPoint('ap3', ssid='ssid-ap3', mode='a', channel='36', position='100,10,0', **kwargs)
    ap4 = net.addAccessPoint('ap4', ssid='ssid-ap4', mode='a', channel='40', position='290,10,0', **kwargs)
    ...
    if '-p' not in args:{
        net.plotGraph(max_x=400,min_x=-50, max_y=400, min_y=-50)}

    if '-s' not in args:
        net.startMobility(time=0)
        net.mobility(Tra1, 'start', time=60, position='30,30,0')
        net.mobility(Tra3, 'start', time=65, position='350,10,0')
        net.mobility(Car1, 'start', time=63, position='50,230,0')
        net.mobility(Tra1, 'stop', time=70, position='350,30,0')
        net.mobility(Tra3, 'stop', time=75, position='30,30,0')
        net.mobility(Car1, 'stop', time=73, position='350,230,0')
        net.stopMobility(time=76)
