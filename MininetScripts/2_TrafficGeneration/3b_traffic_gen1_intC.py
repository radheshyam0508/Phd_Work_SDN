...
def topology():
    ...
    h1.cmd("iperf3 -s -D --logfile /home/student/DTUsCodeTesting/MNScripts/traffictest1_Sr.log")
    info("*** IperfSrv Ready\n")
    sta2.cmd("iperf3 -c 10.0.0.1 --logfile /home/student/DTUsCodeTesting/MNScripts/traffictest1_Cl.log &")
    info("*** IperfCl test launched\n")
